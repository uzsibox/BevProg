...
struct Token //Token construktorok
{
	...
	Token(char ch, string s) : kind(ch), name(s) {}  //konstruktor hiányzott
...
class Token_stream //Token stream cinrõl olvas
{
public:
...
Token Token_stream::get() //Felismeri a különbözõ caseket és switchel megfelelõlen
{
...
void Token_stream::ignore(char c) //Törli a tokent a bufferbõl
{
...
struct Variable //Változók deklarálása
{
	string name;
	double value;
